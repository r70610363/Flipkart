...
const InputField = ({ label, value, onChange, type = "text", maxLength, required = false, className = "" }: any) => (
    <div className={`relative ${className}`}>
        <input 
            ...
            required={required}
            maxLength={maxLength}
            className="peer w-full border border-gray-300 rounded-[2px] px-4 py-3.5 focus:border-[#2874f0] focus:ring-1 focus:ring-[#2874f0] outline-none placeholder-transparent text-sm text-slate-900 bg-white transition-all"
            placeholder={label}
            value={value}
            onChange={onChange}
        />
                            ...
                            <form className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
                                ...
                                <div className="relative md:col-span-2">
                                    <textarea 
                                        required
                                        rows={3}
                                        className="peer w-full border border-gray-300 rounded-[2px] px-4 py-3.5 focus:border-[#2874f0] focus:ring-1 focus:ring-[#2874f0] outline-none placeholder-transparent text-sm text-slate-900 bg-white resize-none transition-all"
                                ...
                                <div className="relative">
                                    <select 
                                        required
                                        className="peer w-full border border-gray-300 rounded-[2px] px-4 py-3.5 focus:border-[#2874f0] focus:ring-1 focus:ring-[#2874f0] outline-none text-sm text-slate-900 bg-white appearance-none"
